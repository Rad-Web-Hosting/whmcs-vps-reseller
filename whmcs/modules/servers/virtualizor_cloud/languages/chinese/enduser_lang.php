...
$l['vm_tip_startstop'] = '开/关 VPS';
$l['vm_tip_restart'] = '重启 VPS';
$l['vm_tip_poweroff'] = '拔 VPS 电源';
$l['vm_tip_hname'] = '更改 VPS 的主机名';
$l['vm_tip_rootpassword'] = '更改 VPS 的 Root密码';
$l['vm_tip_ips'] = '设置主 IP';
$l['vm_tip_vpsconfig'] = '配置一些杂项';
$l['vm_tip_ssh'] = '通过 SSH 连接到 VPS.';
$l['vm_tip_vnc'] = '通过 VNC 连接到 VPS.';
$l['vm_tip_vncpass'] = 'Change the VNC Password.';
$l['vm_tip_os'] = '重新安装当前系统或者直接安装新的操作系统.';
$l['vm_tip_cp'] = '安装您喜欢的控制面板.';
$l['vm_tip_backup'] = '备份或还原VPS.';
$l['vm_tip_monitor'] = '监控 VPS 资源使用情况.';
$l['vm_tip_proc'] = '查看 VPS 运行的进程.';
$l['vm_tip_services'] = '查看 VPS 运行的服务.';
$l['vm_tip_slogs'] = '查看 VPS 状态日志.';
$l['vm_tip_logs'] = '查看 VPS 日志.';
$l['vm_tip_sysalerts'] = '查看 VPS 致命系统警告.';
...
$l['hn_change_onboot'] = '主机名将在VPS重启后生效';
...
$l['bkup_err_backup'] = '在备份的时候发生了错误';
$l['bkup_err_restore'] = '在还原的时候发生了错误';
...
$l['bkup_cbackup'] = '创建备份';
$l['bkup_restore'] = '还原 VPS';
$l['bkup_conf_cbackup'] = '您确认要创建备份 ?';
$l['bkup_conf_restore'] = '确定从最后一次备份还原 ?';
$l['bkup_backup_exp'] = '这里能备份还原您的VPS.';
$l['bkup_backupnotify'] = '正在备份 VPS...';
$l['bkup_restorenotify'] = '正在还原 VPS...';
$l['bkup_backup_email_subject'] = 'VPS 备份已完成';
$l['bkup_restore_email_subject'] = 'VPS 已还原';
$l['bkup_deletevpsbackup_email_subject'] = '备份已删除';
$l['bkup_backup_email_body_start'] = 'VPS 备份进度 : [ ';
$l['bkup_restore_email_body_start'] = 'VPS 还原进度 : [';
$l['bkup_deletevpsbackup_email_body_start'] = '删除 VPS 备份进度 : [';
$l['bkup_backup_email_body_end'] = ' ] 已完成.
You can also view this notification from the Logs Dialog in the VPS Client Panel.

Regards,
{{sn}}';
$l['bkup_err_deletevpsbackup'] = '在删除VPS备份的时候发生了错误';
$l['bkup_del_backup'] = '删除备份';
$l['bkup_done_deletevpsbackup'] = '备份已删除';
$l['bkup_del_backupnotify'] = '正在删除VPS备份...';
$l['bkup_conf_del_backup'] = '您确定删除这些备份 ?';
...
$l['band_Bandwidth_utilised'] = '已使用 : ';
$l['band_percent_utilised'] = '% 已使用 : ';
...
$l['ingredients'] = '配料';
$l['recipe'] = '菜谱';
$l['conf_execute'] = '您确定在您的VPS上烹饪这个菜式?';
