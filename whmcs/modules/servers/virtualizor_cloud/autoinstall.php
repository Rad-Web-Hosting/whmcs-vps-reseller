...
function virtualizor_cloud_installpredefined()
{
	...
	Capsule::table('tblcustomfields')->insert([
        ...
        "fieldoptions" => 'none,3cx-debian-amd64-netinst.iso,AlmaLinux-9.2-x86_64-minimal.iso,alpine-standard-3.16.0-x86_64.iso,antiX-22-net_x64-net.iso,archlinux-2022.07.01-x86_64.iso,artixlinux-base-s6-20230814-x86_64.iso,astlinux-1.4.7-genx86_64-vm.iso,astralinux-alce-2.12.46.6-17.04.2023_15.09.iso,CentOS-7-x86_64-Minimal-2009.iso,CentOS-7-x86_64-NetInstall-2009.iso,CentOS-Stream-8-20230830.0-x86_64-boot.iso,CentOS-Stream-9-20230828.0-x86_64-boot.iso,chimera-linux-x86_64-LIVE-20230611-base.iso,ClearOS-DVD-x86_64-7.9.1.342252.iso,clonezilla-live-3.0.1-8-amd64.iso,CloudLinux-8.8-x86_64-minimal.iso,CloudLinux-DVD-x86_64-7.9.iso,CloudLinux-netinst-x86_64-7.9.iso,coreos-38.20230806.3.0-live.x86_64.iso,debian-10.13.0-amd64-netinst.iso,debian-11.7.0-amd64-netinst.iso,debian-12.1.0-amd64-netinst.iso,debian-9.13.0-amd64-netinst.iso,debian-amd64-netinst-elastix.iso,elementary-os-7.0-stable.20230129rc.iso,Fedora-Server-netinst-x86_64-36-1.5.iso,Fedora-Server-netinst-x86_64-38-1.6.iso,FreeBSD-12.3-RELEASE-amd64-dvd1.iso,FreeBSD-13.0-RELEASE-amd64-dvd1.iso,FreeNAS-11.0-RELEASE.iso,FREEPBX-16-64bit-2208-2-unattended.iso,gentoo-install-amd64-minimal-20220626T170536Z.iso,GoboLinux-017-x86_64.iso,gparted-live-1.0.0-5-amd64.iso,HBCD_PE_x64.iso,ipxe.iso,linuxmint-20.2-cinnamon-64bit.iso,mabox-linux-23.07-Istredd-230729-linux61.iso,Mageia-8-x86_64.iso,manjaro-kde-21.3.7-minimal-220816-linux515.iso,mikrotik-7.5.iso,mikrotik-7.6rc3.iso,mxlinux-21.2.1_x64.iso,netboot.xyz.iso,NetBSD-9.0-amd64.iso,nethserver-7.9.2009-x86_64.iso,nixos-minimal-x86_64-linux.iso,openbsd-amd64-install71.iso,openfileresa-2.99.1-x86_64-disc1.iso,OpenMandrivaLx.4.3-plasma.x86_64.iso,OPNsense-20.7-OpenSSL-dvd-amd64.iso,OPNsense-23.7-dvd-amd64.iso,Parrot-security-5.3_amd64.iso,pfSense-CE-2.4.4-RELEASE-p1-amd64.iso,pfSense-CE-2.6.0-RELEASE-amd64.iso,pop-os_22.04_amd64_intel_32.iso,puppylinux-fossapup64-9.5.iso,Rocky-8.4-x86_64-boot.iso,slackware64-15.0-install-dvd.iso,smeserver-10.1-x86_64-netinstall.iso,SNG7-PBX-64bit-2203-2.iso,sparkylinux-7.0-x86_64-minimalcli.iso,systemrescue-9.04-amd64.iso,TrueNAS-13.0-U2.iso,turnkey-mongodb-16.1-buster-amd64.iso,turnkey-nodejs-16.1-buster-amd64.iso,turnkey-observium-15.1-stretch-amd64.iso,turnkey-openldap-15.0-stretch-amd64.iso,turnkey-redis-16.3-buster-amd64.iso,ubcd539.iso,ubuntu-16.04.4-server-amd64.iso,venomlinux-4.0-x86_64-20220912.iso,ViciBox_v10.x86_64-10.0.2.iso,virtio-win.iso,voidlinux-live-x86_64-20221001-base.iso,vyos-rolling-latest.iso,Windows_2012-R2_SERVER_EVAL_EN-US.ISO,zentyal-7.0-development-amd64.iso,Zorin-OS-16.2-Core-64-bit-r1.iso',
        "regexpr" => '',
        "adminonly" => '',
        "required" => 0,
        "showorder" => 1,
