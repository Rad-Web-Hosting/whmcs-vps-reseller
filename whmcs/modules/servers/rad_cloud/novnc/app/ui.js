...
const UI = {
    ...
    initSettings() {
        ...
        UI.initSetting('host', document.getElementById('noVNC_setting_host').value);
        UI.initSetting('port', document.getElementById('noVNC_setting_port').value);
        ...
        UI.initSetting('path', document.getElementById('noVNC_setting_path').value);
        UI.initSetting('repeaterID', '');
        UI.initSetting('reconnect', false);
        UI.initSetting('reconnect_delay', 5000);
        UI.initSetting('password', document.getElementById('noVNC_setting_password').value);
 ...
 * ------v------*/
    ...
    register_paste_event(){

        document.getElementById('noVNC_clipboard_paste_button').onclick = function() {
